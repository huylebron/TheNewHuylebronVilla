...
public class DashboardService : IDashboardService
{
 ...
 public async Task<PieChartDto> GetBookingPieChartData()
 {
    ...
    (u.Status != Claim.StatusPending || u.Status == Claim.StatusCancelled));
 ...
 public async Task<RadialBarChartDto> GetRegisteredUserChartData()
 {
     ...
     return Claim.GetRadialCartDataModel(totalUsers.Count(), countByCurrentMonth, countByPreviousMonth);
 }

 public async Task<RadialBarChartDto> GetRevenueChartData()
 {
     var totalBookings = _unitOfWork.Booking.GetAll(u => u.Status != Claim.StatusPending
   || u.Status == Claim.StatusCancelled);
     ...
     return Claim.GetRadialCartDataModel(totalRevenue, countByCurrentMonth, countByPreviousMonth);
 }
 ...
 public async Task<RadialBarChartDto> GetTotalBookingRadialChartData()
 {
   ...
   || u.Status == Claim.StatusCancelled);
     ...
     return Claim.GetRadialCartDataModel(totalBookings.Count(), countByCurrentMonth, countByPreviousMonth);
 }
