...
public class BookingController : Controller
{
    ...
    public IActionResult BookingConfirmation(int bookingId)
    {
        ...
        if (bookingFromDb.Status == Claim.StatusPending)
        {
            ...
            {
                _bookingService.UpdateStatus(bookingFromDb.Id, Claim.StatusApproved,0);
    ...
    {
        _bookingService.UpdateStatus(booking.Id, Claim.StatusCheckedIn, booking.VillaNumber);
    ...
    {
        _bookingService.UpdateStatus(booking.Id, Claim.StatusCompleted , booking.VillaNumber);
    ...
    {
        _bookingService.UpdateStatus(booking.Id, Claim.StatusCancelled, 0);
